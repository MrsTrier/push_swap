...
printf "\033[34;1mAtention!! Should be done in less than 8 operations (5 is good)\033[0m\n"
...
printf "\033[34;1mAtention!! Should return Error (bigger than integer)\033[0m\n"
